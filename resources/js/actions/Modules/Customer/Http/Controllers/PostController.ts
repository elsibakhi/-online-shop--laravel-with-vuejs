...
/**
* @see \Modules\Customer\Http\Controllers\PostController::loadPost
* @see Modules/Customer/app/Http/Controllers/PostController.php:45
* @route '/post/load/one/{post}'
*/
export const loadPost = (args: { post: string | number } | [post: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
    url: loadPost.url(args, options),
    method: 'get',
})
...
* @route '/post/load/one/{post}'
*/
loadPost.url = (args: { post: string | number } | [post: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { post: args }
    }
    ...
    return loadPost.definition.url
...
* @route '/post/load/one/{post}'
*/
loadPost.get = (args: { post: string | number } | [post: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'get',
} => ({
    url: loadPost.url(args, options),
...
* @route '/post/load/one/{post}'
*/
loadPost.head = (args: { post: string | number } | [post: string | number ] | string | number, options?: { query?: QueryParams, mergeQuery?: QueryParams }): {
    url: string,
    method: 'head',
} => ({
    url: loadPost.url(args, options),
...
const PostController = { timeline, load, loadPost, like, unlike, index, store, show, update, destroy }
